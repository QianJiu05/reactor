...
def parse_args():
    ...
    p.add_argument("--conn", type=positive_int, default=10000, help="total concurrent connections")
    ...
    p.add_argument("--open-concurrency", type=positive_int, default=2000, help="max concurrent connect attempts")
